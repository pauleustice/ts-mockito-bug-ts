...
describe('ExampleService', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [
        ...
        { provide: ProviderOne, useValue: instance(providerOneMock) },
        { provide: ProviderTwo, useValue: instance(providerTwoMock) },
      ],
    });
  ...
  describe('spying and mocking on service under test', () => {
    it('should spy on ExampleService methods', () => {
